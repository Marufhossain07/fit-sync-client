    ...
    return (
        <div className="flex  justify-between">
            <div className="w-0 lg:w-72">
                ...
                >
                     <h3 className="self-center whitespace-nowrap text-3xl md:text-3xl lg:text-4xl text-[#003049] font-bold my-5 font-sedan dark:text-white">Error<span className="text-[#d62828]">fix</span></h3>
                     <hr className="mb-5"/>
                    <nav
                        aria-label="side navigation"
